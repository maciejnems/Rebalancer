...
from rebalancer.names import POOL, TIMESTAMP, POPULARITY_CACHE, PROFIT, POPULARITY, TRADING_VOLUME, MAX_HISTORY, UPDATE_INTERVAL
    ...
    sim_config = config_sim(
        {
            "N": 1,
            "T": range(blocks),
            "M": {POPULARITY_CACHE: [max_history_cache], UPDATE_INTERVAL: [1]}
        }
    )
